              ...
              <Block flex>
                ...
                <Block flex center>
                  ...
                  >
                    ...
                    <Block row space="evenly" style={{marginVertical:10}} >
                      <Block>
                          <TouchableOpacity onPress={()=>  Linking.openURL(config.domain+"/password/reset").catch(err => console.error("Couldn't load page", err)) } >
                            <Text  size={14} color={argonTheme.COLORS.WARNING}>
                    ...
                    <Block middle>
                      <Button color="WARNING" style={styles.createButton} onPress={()=> signIn({email:email,password:password,expoPushToken:expoPushToken,toastok:toastok,toasterror:toasterror})}>
