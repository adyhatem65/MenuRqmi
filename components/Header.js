...
class Header extends React.Component {
  ...
  renderSearch = () => {
    const { navigation, searchPlaceholder } = this.props;
    return (
      <Input
        right
        color="black"
        ...
        onChange={({ nativeEvent: { text } }) => {
          navigation.getParam('doSearch')(text);
        }}
  ...
  render() {
    const { back, title, white=true, transparent, bgColor, iconColor, titleColor, routeName, navigation, ...props } = this.props;
          ...
          <NavBar
            ...
            left={
              <Icon
                ...
                color={white ? "white" : iconColor || argonTheme.COLORS.ICON} />
            }
