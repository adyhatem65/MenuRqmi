export default Language = {
   ...
   no_items:"There are No orders to Show",
   ...
   email_err_msg:"The email field is required.",
   pass_err_msg: "The password field is required.",
   name_err_msg:"The name field is required.",
   vendor_name_err_msg:"The vendor name field is required.",
   phone_err_msg:"The phone field is required.",
   today_order:"Latest Orders",
   table:"Table Number",
   Drivers:"Drivers",
   choose_Drivers:"Save",
   drivers_err: "error while getting drivers"
  }